...
open class MDVTabBarController: UITabBarController {
    ...
    //MARK:- Properties
    weak var mdvTabBarControllerDataSource: MDVTabBarControllerDataSource? {
        didSet {
            self.configureViews()
        }
    }
    var mdvTabBarControllerDelegate : MDVTabBarControllerDelegate?
    ...
    private func configureViews() {
        ...
        viewControllers = dataSource.tabBarControllerViewControllers() as? [UIViewController]
